...
function marqueeGatherData(){
    $('.marquee .marquee_data').each(function(index){
        ...
        marqueeVars.panelContent[index] = 
            '<div class="marquee_panel" datda-image-s="'+panel_image_s+'" style="background: url('+panel_image_l+');"><div class="overlay"></div><div class="panel_caption">'+panel_caption+'</div></div>';
...
/*********************************      marqeeMultiPanel     */
function marqeeMultiPanel(){
	marqueeVars.timePassed = 0;
	marqueeVars.autoPlay = true;
	var newHTML = '<div class="marquee_stage_large"><div class="marquee_container_1"></div><div class="marquee_nav"></div><div class="btn prev"><span class="fa fa-angle-left"></span></div><div class="btn next"><span class="fa fa-angle-right"></span></div></div>';
...
/*********************************      debugTimes     */
var debugTimes = setInterval(setDebugger, 100);
